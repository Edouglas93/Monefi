        ...
        <Card.Body>
          <div className='d-lg-flex align-items-center justify-content-between'>
            <div className='d-flex align-items-center mb-4 mb-lg-0'>
              <Image
                src={state.payload.user.avatarUrl}
                id='img-uploaded'
            ...
            <Row>
              <Col md={6} sm={12} className='mb-3'>
                <div className='mb-3'>
                  ...
                  <Card.Header>
                    <div>{state.payload.user.firstName} </div>
                  </Card.Header>
                </div>
              </Col>
              <Col md={6} sm={12} className='mb-3'>
                <div className='mb-3'>
                  ...
                  <Card.Header>
                    <div>{state.payload.user.lastName}</div>
                  </Card.Header>
                </div>
              </Col>
              <Col md={6} sm={12} className='mb-3'>
              ...
              <Col md={6} sm={12} className='mb-3'>
                <div className='mb-3'>
                  ...
                  <Card.Header>
                    <div>{state.payload.statusType.name}</div>
                  </Card.Header>
                </div>
              </Col>
